...
-- +migrate Up
CREATE PROCEDURE [IR5].[test participant is 1 year old]
AS
BEGIN
	--Assemble
...
-- +migrate Up
CREATE PROCEDURE [IR5].[test participant is 5 years old]
AS
BEGIN
	--Assemble
	EXEC tSQLt.FakeTable 'dbo', 'PLAYER'
...
-- +migrate Up
CREATE PROCEDURE [IR5].[test participant is 3 years old]
AS
BEGIN
	--Assemble
	EXEC tSQLt.FakeTable 'dbo', 'PLAYER'

...
CREATE PROCEDURE IR14.test_black_player_is_same_as_white_player AS
    BEGIN
        ...
        EXEC tSQLt.ApplyConstraint @Tablename = 'dbo.CHESSMATCH_OF_POULE',
                                   @ConstraintName = 'CK_BLACK_CANNOT_BE_THE_SAME_AS_WHITE'
        EXEC tSQLt.ExpectException
        -- Execute
        INSERT INTO CHESSMATCH_OF_POULE (playeridblack, playeridwhite) VALUES (1, 1)
...
CREATE PROCEDURE IR14.test_black_player_is_not_same_as_white_player AS
    BEGIN
        ...
        -- Execute
        INSERT INTO CHESSMATCH_OF_POULE (playeridblack, playeridwhite) VALUES (1, 2)

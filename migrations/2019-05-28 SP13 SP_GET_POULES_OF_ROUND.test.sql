...
AS
    BEGIN
        ...
        INSERT INTO TOURNAMENT (tournamentname, chessclubname) VALUES ('tourny1', 'cc1')
        EXEC tSQLt.FakeTable 'dbo', 'TOURNAMENT_ROUND'
        INSERT INTO TOURNAMENT_ROUND (chessclubname, tournamentname, roundnumber)
        VALUES ('cc1', 'tourny1', 1)
        EXEC tSQLt.FakeTable 'dbo', 'POULE'
        INSERT INTO POULE
        VALUES ('cc1', 'tourny1', 1, 1),
            ('cc1', 'tourny1', 1, 2),
        ...
        EXEC tSQLt.ExpectException
            @ExpectedMessage = 'There is no round with this roundnumber in this tournament'

        EXEC SP_GET_POULES_OF_ROUND 'cc1', 'tourny1', 3
    END;

-- +migrate Up
CREATE PROCEDURE [SP13].[Test get single poule]
AS
    BEGIN
        --Arrange
        EXEC tSQLt.FakeTable 'dbo', 'CHESSCLUB'
        ...
        SELECT * into expected from POULE WHERE pouleno = 1
        ...
        INSERT INTO actual EXEC SP_GET_POULES_OF_ROUND 'cc1', 'tourny1', 1, 1
